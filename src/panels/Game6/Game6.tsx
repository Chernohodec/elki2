...
import item1Image from "../../assets/img/tasks/task6/item1.png";
import item2Image from "../../assets/img/tasks/task6/item2.png";
import item3Image from "../../assets/img/tasks/task6/item3.png";
import item4Image from "../../assets/img/tasks/task6/item4.png";
import item5Image from "../../assets/img/tasks/task6/item5.png";
import item6Image from "../../assets/img/tasks/task6/item6.png";
import onboardingStep1 from "../../assets/img/tasks/task6/task6-onboarding1.png";
import onboardingStep2 from "../../assets/img/tasks/task6/task6-onboarding2.png";
import game6Title from "../../assets/img/tasks/task6/task6-title.png";
...
export const Game6: FC<NavIdProps> = ({ id, updateTasks }) => {
    ...
    const onboardingSteps = [
        <div className={css["onboarding-step1"]}>
            <img width={275} src={onboardingStep1} alt="" />
        </div>,
        <div className={css["onboarding-step2"]}>
            <img width={340} src={onboardingStep2} alt="" />
        </div>,
    ];
                        ...
                        {counters.map((counter, index) => (
                            ...
                            >
                                <img
                                    ...
                                    width={66}
                                    height={66}
                                    className={css["game-header__item-image"]}
                                />
                                <span
                                    className={css["game-header__item-counter"]}
                                >
